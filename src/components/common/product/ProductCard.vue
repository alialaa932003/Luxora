  ...
  >
    <div
      ...
      :class="
        orientation === 'horizontal'
          ? 'sm:w-48 shrink-0 aspect-square sm:aspect-auto'
          : 'aspect-square'
      "
    >
      ...
      <div
        class="absolute top-3 left-3 flex flex-wrap gap-1.5 pointer-events-none z-10"
      >
        <span
          v-if="hasDiscount"
    ...
    <div class="flex flex-col p-5 flex-1 justify-between gap-4">
      <div class="flex flex-col gap-2">
        <span
          class="text-[10px] font-extrabold uppercase tracking-widest text-muted-foreground"
        >
        ...
        <div class="flex justify-between items-start gap-4">
          ...
          <div class="flex flex-col items-end shrink-0">
            <PriceComponent
              ...
              class="text-sm sm:text-base font-extrabold text-foreground"
            />
            <span
              v-if="hasDiscount"
      ...
      <div
        class="flex items-center justify-between pt-3 border-t border-border/40 mt-auto"
      >
        <div class="flex items-center gap-2">
          <div
            class="w-5.5 h-5.5 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden"
          >
            <Store :size="10" class="text-primary" />
          </div>
          <span
            class="text-[11px] font-semibold text-muted-foreground hover:text-foreground transition-colors cursor-pointer leading-none"
          >
