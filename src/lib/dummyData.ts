...
export const dummyProducts: Product[] = [
  {
    ...
    description: 'High-fidelity audio with active noise cancellation, handcrafted leather padding, and up to 40 hours of battery life. Professional studio tuning for audiophiles.',
    price: 349.99,
  ...
  },
  {
    ...
    description: 'RFID-blocking full-grain leather cardholder with space for 8 cards and flat cash. Beautifully slim profile, handcrafted to last a lifetime.',
    price: 49.99,
    originalPrice: 79.99,
    currency: 'USD',
    ...
    category: { id: 'cat_002', name: 'Apparel & Fashion', slug: 'fashion' },
  ...
  },
  {
    ...
    description: 'Keep your drink at the perfect temperature all day. Charging coaster included. Safe, intelligent heating, elegant ceramic construction.',
    price: 99.99,
  ...
  },
  {
    ...
    description: 'Hydrating blend of organic marula, jojoba, and rosehip oils. Revitalizes skin radiance naturally, chemical-free and dermatologist approved.',
    price: 64.99,
    originalPrice: 89.99,
    currency: 'USD',
    ...
    category: { id: 'cat_004', name: 'Wellness & Beauty', slug: 'beauty' },
  ...
  },
  {
    ...
    description: 'Ultrasonic aroma diffuser housed in a stone-crafted ceramic shell. Silent operation with automatic shutoff, fits beautifully in any space.',
    price: 119.99,
  ...
  },
  {
    ...
    description: 'Sleek aluminum base, hot-swappable tactile switches, wireless connectivity, and premium Jakarta typography keycaps. Engineered for productivity.',
    price: 189.99,
